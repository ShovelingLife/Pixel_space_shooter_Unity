...
{
    // Position variables
    protected Vector3[]      m_spawn_pos_arr;
    protected Vector3[]      m_target_pos_arr;
    protected int            m_current_point_index;
    ...
    public    Sprite[]       plane_sprite_arr;
    ...
    protected void Enemy_inclining(e_plane_state _plane_state)
    {
        switch (_plane_state)
        {
            case e_plane_state.RIGHT: // 오른쪽
                ...
                m_current_sprite_rend.sprite = plane_sprite_arr[2];
                break;
            ...
            case e_plane_state.IDLE: // 정지 상태
                this.transform.rotation = Global.zero_rotation;
                m_current_sprite_rend.sprite = plane_sprite_arr[0];
                break;
        }
    }
